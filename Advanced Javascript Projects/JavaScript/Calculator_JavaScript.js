...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Operand is true and sts Display_Value
...
//This ensures handles decimal points.
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that the AC clears all inputs from the calculator screen.
