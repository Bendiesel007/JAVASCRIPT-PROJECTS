...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Change the activePlayer 'X'
            activePlayer = 'X';
        }
        //This function plays placement sound.
        audio('media/master_of_dreams_handbell_7_418.mp3');
...
function checkWinConditions() {
    ...
    // O 2, 5, 8 condition.
    else if (arrayIncludes('2O', '50', '80')) { drawWinLine(508, 50, 508, 558) }
    // O 6, 4, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us access o methods and properties to use on canvas.
